<template>
  <div class="q-pa-md">
    <q-table
      ...
      @update:pagination="(e) => updatePaginate(e)"
    ...
    >
      ...
      <template v-slot:top>
        ...
        <q-btn
          ...
          label="Filter"
          dense
          title="open filter popup"
        />
        <q-btn
          class="q-mr-sm"
          icon="clear"
          color="red"
          @click="clearFilterAndApply"
          dense
          title="clear filter"
        />
        <q-space />
      ...
      <template v-slot:pagination="scope">
        ...
        <q-btn
          ...
          dense
          flat
          :disable="props.page == props.pages"
          @click="() => navigateToPage(props.page + 1)"
        />
        ...
        <q-btn
          ...
          flat
          :disable="props.page == props.pages"
          @click="() => navigateToPage(props.pages)"
        />
    ...
    <q-dialog v-model="filterPopup" persistent>
      <q-card style="width: 400px; max-width: 80vw">
        <q-card-section>
          ...
          <q-select
            v-model="dataFilter.filterColumn"
            outlined
            dense
            options-dense
            emit-value
          ...
          <q-input
            v-model:model-value="dataFilter.keywords"
            outlined
            dense
            type="text"
        ...
        <q-card-section class="q-pt-none">
          <div>
            ...
            <q-input
              v-model:model-value="dataFilter.gt"
              outlined
              dense
              type="date"
              debounce="1000"
            ...
            <span>To</span>
            <q-input
              v-model:model-value="dataFilter.lt"
              outlined
              dense
              type="date"
              debounce="1000"
        ...
        <q-card-section class="q-pt-none">
          ...
          <div>
            <q-select
              v-model="dataFilter.rangeColumn"
              outlined
              dense
              options-dense
              emit-value
              ...
              :options="filterOptions"
              option-value="name"
              title="range filter key"
              options-cover
            />
            <span>From </span>
            <q-input
              v-model:model-value="dataFilter.gtValue"
              outlined
              dense
              type="number"
              debounce="1000"
            ...
            <span>To </span>
            <q-input
              v-model:model-value="dataFilter.ltValue"
              outlined
              dense
              type="number"
              debounce="1000"
